...
import { copypastaPublications, copypastaTalks, copypastaPress } from './copypasta';
        ...
        <Layout description="Publications of the Lingua Franca">
            <div className="section">
                <div className="container">
                    <Heading as="h2" className={clsx("margin-bottom--lg", "text--center")}>Featured publications of the Lingua Franca</Heading>
            ...
            <div className="section sectionAlt">
                <div className="container">
                    <Heading as="h2" className={clsx("margin-bottom--lg", "text--center")}>Other relevant publications</Heading>
            ...
            <div className="section">
                <div className="container">
                    <Heading as="h2" className={clsx("margin-bottom--lg", "text--center")}>Presentations</Heading>
                    {copypastaTalks}
                </div>
            </div>
            <div className="section sectionAlt">
                <div className="container">
                    <Heading as="h2" className={clsx("margin-bottom--lg", "text--center")}>Press Coverage</Heading>
                    {copypastaPress}
                </div>
            </div>
        </Layout>
