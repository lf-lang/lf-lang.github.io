        ...
        <div className="container">
          ...
          <div className={clsx("row")} style={{ justifyContent: "center" }}>
            ...
            <SocialMediaCard
              ...
              name="Organization and Roles"
            >
              <>
                Learn how the LF community is organized and how work gets done.{" "}
                <Link to="/community/organization-and-roles/">
                  View Organization and Roles.
                </Link>
              </>
            </SocialMediaCard>
