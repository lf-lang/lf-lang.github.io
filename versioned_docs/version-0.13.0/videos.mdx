...
* [Tutorial from CPS-IoT Week 2026](#tutorial-from-cps-iot-week-2026)
* [Technical Talks](#technical-talks)
* [Weekly Research Meetings](#weekly-research-meetings)
* [Short Course](#short-course)
* [Tutorial from 2021](#tutorial-from-2021)

## Tutorial from CPS-IoT Week 2026

On May 11, 2026, we offered a half-day hands-on tutorial on Lingua Franca at [CPS-IoT Week 2026](https://cps-iot-week2026.inria.fr/) in Saint Malo, France. The tutorial introduced Lingua Franca as an open-source coordination language for deterministic integration of cyber-physical systems.

**Useful links:**

- [Complete video playlist](https://youtube.com/playlist?list=PLjKT6j1T2HKXT03OdyCmPG0P4AyKIVc3v)
- [Tutorial event page](/events/cpsweek-2026-tutorial)
- [Hands-on exercises on GitHub](https://github.com/lf-lang/lf-tutorial-handson-2026)

| Session | Duration | Video |
|---------|----------|-------|
| [Introductory Presentations](https://www.youtube.com/watch?v=WvBkGGoFJ14) | 65 min | Introduction to CPS concurrency challenges, reactor-oriented programming, and key LF concepts |
| [Live Demos](https://www.youtube.com/watch?v=lp4w3sL77-Y) | 40 min | CPS-focused example applications including distributed execution and physics simulation |
| [Installation and Hello World](https://www.youtube.com/watch?v=_DVXODzAQFo) | 20 min | Setting up the LF toolchain and walking through a minimal example |
| [Hands-on Programming Sessions](https://www.youtube.com/watch?v=raulYqpX6oU) | 90 min | Interactive coding exercises with distributed CPS examples |
