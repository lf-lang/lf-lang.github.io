...
If you would like to configure a virtual machine, see [lf-lang/lfc-multipass](https://github.com/lf-lang/lfc-multipass) (courtesy of [Xronos Inc.](https://xronos.com)) for a cloud-init script to install Lingua Franca tools using multipass.
