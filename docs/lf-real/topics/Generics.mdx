...
import C_GenericDelay from '../code/c/src/GenericDelay.lf';
import Cpp_GenericDelay from '../code/cpp/src/GenericDelay.lf';
...
import C_GenericString from '../code/c/src/GenericString.lf';
import Cpp_GenericString from '../code/cpp/src/GenericString.lf';
