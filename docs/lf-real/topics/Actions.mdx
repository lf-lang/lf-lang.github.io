...
import {
  ...
  ShowIf, ShowIfs, ShowOnly, LangSpecificInlineForString
...
import C_Schedule from '../code/c/src/Schedule.lf';
import Cpp_Schedule from '../code/cpp/src/Schedule.lf';
import Py_Schedule from '../code/py/src/Schedule.lf';
import Rs_Schedule from '../code/rs/src/Schedule.lf';
import TS_Schedule from '../code/ts/src/Schedule.lf';

<NoSelectorTargetCodeBlock c={C_Schedule} cpp={Cpp_Schedule} py={Py_Schedule} rs={Rs_Schedule} ts={TS_Schedule} lf />

![Lingua Franca diagram](../../img/diagrams/Schedule.svg)
...
The time argument is required to be non-negative. If it is zero, then the action will be scheduled one **microstep** later. See [Superdense Time](<../topics/Superdense Time.mdx>).
...
import C_Physical from '../code/c/src/Physical.lf';
import Cpp_Physical from '../code/cpp/src/Physical.lf';
import Py_Physical from '../code/py/src/Physical.lf';
import Rs_Physical from '../code/rs/src/Physical.lf';
import TS_Physical from '../code/ts/src/Physical.lf';

<NoSelectorTargetCodeBlock c={C_Physical} cpp={Cpp_Physical} py={Py_Physical} rs={Rs_Physical} ts={TS_Physical} lf />

![Lingua Franca diagram](../../img/diagrams/Physical.svg)

If you drive this with a timer, using for example the following structure:

![Lingua Franca diagram](../../img/diagrams/PhysicalTest.svg)
...
import C_Asynchronous from '../code/c/src/Asynchronous.lf';
import Cpp_Asynchronous from '../code/cpp/src/Asynchronous.lf';
import Py_Asynchronous from '../code/py/src/Asynchronous.lf';
import Rs_Asynchronous from '../code/rs/src/Asynchronous.lf';
import TS_Asynchronous from '../code/ts/src/Asynchronous.lf';
...
First, the [file-level $preamble$](<../topics/Preambles.mdx>) has `#include "platform.h"`, which includes the declarations for functions it uses, `lf_sleep` and `lf_thread_create` (see [Libraries Available to Programmers](/docs/handbook/target-language-details?target=c#libraries-available-to-programmers)).
...
The `external` function executed by the thread is defined in a reactor-level $preamble$ section. See [Preambles](<../topics/Preambles.mdx>).
