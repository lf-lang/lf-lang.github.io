...
- The **effects** field, which is also optional, is a comma-separated lists of output ports ports, input ports of contained reactors, or [actions](<../topics/Actions.mdx>).
...
import C_Alignment from '../code/c/src/Alignment.lf';
import Cpp_Alignment from '../code/cpp/src/Alignment.lf';
import Py_Alignment from '../code/py/src/Alignment.lf';
import Rs_Alignment from '../code/rs/src/Alignment.lf';
import TS_Alignment from '../code/ts/src/Alignment.lf';
...
import C_Overwriting from '../code/c/src/Overwriting.lf';
import Cpp_Overwriting from '../code/cpp/src/Overwriting.lf';
import Py_Overwriting from '../code/py/src/Overwriting.lf';
import Rs_Overwriting from '../code/rs/src/Overwriting.lf';
import TS_Overwriting from '../code/ts/src/Overwriting.lf';
...
import C_Contained from '../code/c/src/Contained.lf';
import Cpp_Contained from '../code/cpp/src/Contained.lf';
import Py_Contained from '../code/py/src/Contained.lf';
import Rs_Contained from '../code/rs/src/Contained.lf';
import TS_Contained from '../code/ts/src/Contained.lf';
...
import C_Triggering from '../code/c/src/Triggering.lf';
import Cpp_Triggering from '../code/cpp/src/Triggering.lf';
import Py_Triggering from '../code/py/src/Triggering.lf';
import Rs_Triggering from '../code/rs/src/Triggering.lf';
import TS_Triggering from '../code/ts/src/Triggering.lf';
...
A reaction to $startup$ is triggered at the very first tag when the program begins (or, if within a mode of a [modal reactor](<../topics/Modal Models.mdx>), when the mode is first entered).
This reaction will be logically simultaneous with reactions to [timers](<../topics/Time and Timers.mdx>) that have a zero offset.
...
See the [Termination](<../topics/Termination.mdx>) section for details.

<ShowIfs>

<ShowIf cpp ts rs>

Reactions to the $reset$ event are not supported in $target-language$ because [modal reactors](<../topics/Modal Models.mdx>) are not supported.

</ShowIf>

<ShowIf c py>

A reaction to the $reset$ event is invoked if the reaction or reactor is within a mode of a [modal reactor](<../topics/Modal Models.mdx>) and the mode is entered via a reset transition.
For details, see the [Modal Reactors](<../topics/Modal Models.mdx>) section.
