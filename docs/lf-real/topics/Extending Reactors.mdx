...
import C_Extends from '../code/c/src/Extends.lf';
import Py_Extends from '../code/py/src/Extends.lf';
import Rs_Extends from '../code/rs/src/Extends.lf';
import TS_Extends from '../code/ts/src/Extends.lf';
