...
<ShowOnly uc>
The [attribute `@timeout`](https://micro-lf.org/documentation/annotations/) specifies the last logical time at which reactions should be triggered. The last invocation of reactions will be at tag (`timeout`, 0).
</ShowOnly>
