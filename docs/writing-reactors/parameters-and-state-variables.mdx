...
- A code block delimited by `{= ... =}`, where the content is any valid type in the target language.
...
import UC_Scale from '../assets/code/uc/src/Scale.lf';
...
<NoSelectorTargetCodeBlock c={C_Scale} uc={UC_Scale} cpp={Cpp_Scale} py={Py_Scale} rs={Rs_Scale} ts={TS_Scale} lf />
...
import UC_Count from '../assets/code/uc/src/Count.lf';
...
<NoSelectorTargetCodeBlock c={C_Count} uc={UC_Count} cpp={Cpp_Count} py={Py_Count} rs={Rs_Count} ts={TS_Count} lf />
