...
import UC_GenericDelay from '../assets/code/uc/src/GenericDelay.lf';
import Cpp_GenericDelay from '../assets/code/cpp/src/GenericDelay.lf';

<NoSelectorTargetCodeBlock c={C_GenericDelay} uc={UC_GenericDelay} cpp={Cpp_GenericDelay} lf />
...
import UC_GenericString from '../assets/code/uc/src/GenericString.lf';
import Cpp_GenericString from '../assets/code/cpp/src/GenericString.lf';

<NoSelectorTargetCodeBlock c={C_GenericString} uc={UC_GenericString} cpp={Cpp_GenericString} lf />
