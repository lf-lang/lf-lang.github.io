...
import UC_Cycle from '../assets/code/uc/src/Cycle.lf';
...
<NoSelectorTargetCodeBlock c={C_Cycle} uc={UC_Cycle} cpp={Cpp_Cycle} py={Py_Cycle} rs={Rs_Cycle} ts={TS_Cycle} lf />
...
import UC_CycleWithDelay from '../assets/code/uc/src/CycleWithDelay.lf';
...
<NoSelectorTargetCodeBlock c={C_CycleWithDelay} uc={UC_CycleWithDelay} cpp={Cpp_CycleWithDelay} py={Py_CycleWithDelay} rs={Rs_CycleWithDelay} ts={TS_CycleWithDelay} lf />
...
import UC_CycleReordered from '../assets/code/uc/src/CycleReordered.lf';
...
<NoSelectorTargetCodeBlock c={C_CycleReordered} uc={UC_CycleReordered} cpp={Cpp_CycleReordered} py={Py_CycleReordered} rs={Rs_CycleReordered} ts={TS_CycleReordered} lf />
