...
import UC_Multiport from '../assets/code/uc/src/Multiport.lf';
...
<NoSelectorTargetCodeBlock c={C_Multiport} uc={UC_Multiport} cpp={Cpp_Multiport} py={Py_Multiport} rs={Rs_Multiport} ts={TS_Multiport} lf />
...
import UC_Sparse from '../assets/code/uc/src/Sparse.lf';

<NoSelectorTargetCodeBlock c={C_Sparse} uc={UC_Sparse} lf />
...
import UC_MultiportSource from '../assets/code/uc/src/MultiportSource.lf';
...
<NoSelectorTargetCodeBlock c={C_MultiportSource} uc={UC_MultiportSource} cpp={Cpp_MultiportSource} py={Py_MultiportSource} rs={Rs_MultiportSource} ts={TS_MultiportSource} lf />
...
import UC_BankIndex from '../assets/code/uc/src/BankIndex.lf';
import Py_BankIndex from '../assets/code/py/src/BankIndex.lf';

<NoSelectorTargetCodeBlock c={C_BankIndex} uc={UC_BankIndex}  py={Py_BankIndex} lf />
...
import UC_ChildBank from '../assets/code/uc/src/ChildBank.lf';
...
<NoSelectorTargetCodeBlock c={C_ChildBank} uc={UC_ChildBank} cpp={Cpp_ChildBank} py={Py_ChildBank} rs={Rs_ChildBank} ts={TS_ChildBank} lf />
...
import UC_ChildParentBank from '../assets/code/uc/src/ChildParentBank.lf';
...
<NoSelectorTargetCodeBlock c={C_ChildParentBank} uc={UC_ChildParentBank} cpp={Cpp_ChildParentBank} py={Py_ChildParentBank} rs={Rs_ChildParentBank} ts={TS_ChildParentBank} lf />
...
import UC_ChildParentBank2 from '../assets/code/uc/src/ChildParentBank2.lf';
...
<NoSelectorTargetCodeBlock c={C_ChildParentBank2} uc={UC_ChildParentBank2} cpp={Cpp_ChildParentBank2} py={Py_ChildParentBank2} rs={"ChildParentBank2.lf missing for Rust"} ts={TS_ChildParentBank2} lf />
...
import UC_MultiportToBank from '../assets/code/uc/src/MultiportToBank.lf';
...
<NoSelectorTargetCodeBlock c={C_MultiportToBank} uc={UC_MultiportToBank} cpp={Cpp_MultiportToBank} py={Py_MultiportToBank} rs={Rs_MultiportToBank} ts={TS_MultiportToBank} lf />
...
import UC_Interleaved from '../assets/code/uc/src/Interleaved.lf';
...
<NoSelectorTargetCodeBlock c={C_Interleaved} uc={UC_Interleaved} cpp={Cpp_Interleaved} py={Py_Interleaved} lf />
