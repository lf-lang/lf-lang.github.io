...
import UC_Alignment from '../assets/code/uc/src/Alignment.lf';
...
<NoSelectorTargetCodeBlock c={C_Alignment} uc={UC_Alignment} cpp={Cpp_Alignment} py={Py_Alignment} rs={Rs_Alignment} ts={TS_Alignment} lf />
...
import UC_Overwriting from '../assets/code/uc/src/Overwriting.lf';
...
<NoSelectorTargetCodeBlock c={C_Overwriting} uc={UC_Overwriting} cpp={Cpp_Overwriting} py={Py_Overwriting} rs={Rs_Overwriting} ts={TS_Overwriting} lf />
...
A reaction may be triggered by an input to the reactor, but also by an output of a contained reactor, as illustrated in the following example:

import C_Contained from '../assets/code/c/src/Contained.lf';
import UC_Contained from '../assets/code/uc/src/Contained.lf';
...
<NoSelectorTargetCodeBlock c={C_Contained} uc={UC_Contained} cpp={Cpp_Contained} py={Py_Contained} rs={Rs_Contained} ts={TS_Contained} lf />
...
import UC_Triggering from '../assets/code/uc/src/Triggering.lf';
...
<NoSelectorTargetCodeBlock c={C_Triggering} uc={UC_Triggering} cpp={Cpp_Triggering} py={Py_Triggering} rs={Rs_Triggering} ts={TS_Triggering} lf />
...
Reactions may be triggered by the special events `startup`, `shutdown`, or `reset` (if modal reactors are supported).
For example,
