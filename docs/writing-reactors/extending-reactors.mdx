...
<LanguageSelector c uc py ts rs />
...
import UC_Extends from '../assets/code/uc/src/Extends.lf';
...
<NoSelectorTargetCodeBlock c={C_Extends} uc={UC_Extends} py={Py_Extends} rs={Rs_Extends} ts={TS_Extends} lf />
