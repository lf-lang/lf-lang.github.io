...
Declaration](<../writing-reactors/Parameters and State Variables.mdx#state-declaration>) to
...
and State](<../writing-reactors/Parameters and State Variables.mdx>) for more examples.
...
Outputs](<../writing-reactors/Inputs and Outputs.mdx>).
