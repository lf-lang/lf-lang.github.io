...
Every Lingua Franca program begins with a [target declaration](target-declaration) that specifies the language in which reactions are written. This is also the language of the program(s) generated by the Lingua Franca code generator.
