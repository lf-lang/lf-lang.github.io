  ...
  const loadDocSearch = () => {
    ...
    if (isDev) {
      customHandleSelected = (input, event, suggestion, datasetNumber, context) => {
        const urlToOpen = suggestion.url.replace("www.lf-lang.github.io", "localhost:8000").replace("https", "http")
    ...
    <header dir="ltr">
      ...
      <div id="top-menu" className="up">
        <div className="left below-small">
          ...
          <img id="lf-logo" width={25} height={25} src={require("../../../../../img/Lingua_Franca.png").default} alt="Lingua Franca Logo"/>
