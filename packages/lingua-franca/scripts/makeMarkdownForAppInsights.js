 ...
 * run with:
    APP_INSIGHTS_ID="X" APP_INSIGHTS_API_KEY="Y" node packages/lingua-franca/scripts/makeMarkdownForAppInsights.js
  */

const nodeFetch = require("node-fetch").default
const querystring = require("querystring")

// Get these from: https://ms.portal.azure.com/#@microsoft.onmicrosoft.com/resource/subscriptions/57bfeeed-c34a-4ffd-a06b-ccff27ac91b8/resourceGroups/lingua-franca/providers/microsoft.insights/components/TypeScriptLang-Prod-Ai/apiKeys
...
| order by dimension asc`)
  ...
  mds.push(
    `This was last updated ${today.getDate()}/${today.getMonth()}/${today.getFullYear()}. Created with [this script](https://github.com/microsoft/TypeScript-website/blob/v2/packages/lingua-franca/scripts/makeMarkdownForAppInsights.js).`
  )
