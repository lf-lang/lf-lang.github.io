...
/* Run with 
  ...
  node packages/lingua-franca/lib/themes/themeGen.js
...
const map = {
  "#0000ff": colors.mutedBlueAAA,
  "#008000": colors.darkGreenAAA,
}

const lightPlus = require("shiki/themes/light-plus.json")

const lightTheme = JSON.parse(JSON.stringify(lightPlus))
lightTheme.theme = "TypeScript"

Object.entries(map).forEach(from => {
  changeInJSON(from, map[from], lightTheme)
})
...
function changeInJSON(id, value, obj) {
