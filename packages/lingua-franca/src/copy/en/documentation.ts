export const docCopy = {
  doc_layout_title: "Lingua Franca Documentation",
  doc_layout_description:
    "Find Lingua Franca starter projects: from Python to C to C++ to TypeScript.",
  doc_bootstrap_title: "Bootstrapping tools for Lingua Franca projects",
  ...
  doc_start_a_project_desc:
    "Because Lingua Franca is a super-set of JavaScript, it doesn't have a default template - there would be too many. Instead, other projects have their own Lingua Franca bootstrap templates with their own context. These projects provide templates which include Lingua Franca support.",
  doc_node_npm: "Node with npm",
  doc_node_npm_oclif_blurb: "Create command line tools your users love",
  doc_node_npm_gluegun_blurb:
    "A delightful toolkit for building Lingua Franca-powered command-line apps",
  ...
  doc_apis_wechat_blurb: "Use the WeChat JSSDK with Lingua Franca",
  doc_apis_loopback_blurb:
    "A highly extensible Node.js and Lingua Franca framework for building APIs and microservices",
  ...
  doc_learn: "Familiar With Lingua Franca already?",
  ...
  doc_learn_playground_blurb: "Explore and share Lingua Franca online",
}
